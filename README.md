...
```
## OUTPUT:
![Screenshot 2025-04-25 000150](https://github.com/user-attachments/assets/637b8baf-5968-4918-9c19-5e5badb4e161)

## RESULT:
The host took 0.881561 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.008195 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
